...
require('lazy').setup({
    ...
    config = function()
      ...
      require('mason-lspconfig').setup {
        handlers = {
          ...
          --           location = '/Users/hongci/.nvm/versions/node/v18.12.1/lib/node_modules/@vue/typescript-plugin',
  ...
  -- Create init.lua file in custom/plugins, return plugin blocks and use the following line.
